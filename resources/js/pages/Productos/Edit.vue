...
export default {
    ...
    methods: {
        obtener_imagen(e){ //Cuando se carga la imagen se dispara este método
        ...
        cargarImagen(file){ //Método para la previsualización de la imagen
            let lector = new FileReader(); //Este método permite trabajar con archivos

            lector.onload = (e) => { //Este método nos permite cargar la información del archivo o imagen
